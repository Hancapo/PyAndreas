...
on_ped_damage = _simple("ped_damage")
on_ped_death = _simple("ped_death")
on_vehicle_enter = _simple("vehicle_enter")
on_vehicle_exit = _simple("vehicle_exit")
on_weapon_changed = _simple("weapon_changed")
on_zone_enter = _simple("zone_enter")
on_zone_exit = _simple("zone_exit")
